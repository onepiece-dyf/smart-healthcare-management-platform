    ...
    <div class="p-3">
      ...
      <div class="mb-2 flex items-center justify-between">
        <div class="flex items-center">
          ...
          <span class="font-medium">{{ order.patient?.name || '未知患者' }}</span>
          <span class="ml-2 text-sm text-gray-500">
            床号：{{ order.patient?.bedId || '未分配' }}
          </span>
        </div>
        <div v-if="order.doctorDepartment" class="text-xs text-gray-400">
      ...
      <div class="text-sm text-gray-500">
        <div class="flex items-center">
          ...
          <span>频次：{{ order.frequency || '未指定' }}</span>
        </div>
      ...
      <div class="flex items-center justify-between border-t border-gray-100 bg-gray-50 p-3">
        <div class="text-sm text-gray-500">
          ...
          医生：{{ order.doctor?.name || order.doctorName || '未指定' }}
        </div>
